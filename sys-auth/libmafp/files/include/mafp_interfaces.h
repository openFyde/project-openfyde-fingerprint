#ifndef __MAFP_INTERFACES_H__
#define __MAFP_INTERFACES_H__
...
typedef enum fingerprint_error {
    ...
    FINGERPRINT_ERROR_AUTHENTICATED = FINGERPRINT_ERROR_VENDOR_BASE + 1
} fingerprint_error_t;
...
typedef enum fingerprint_acquired_info {
    ...
    FINGERPRINT_ACQUIRED_BASE_DOWN = 1002, /* for transage finger down */
    FINGERPRINT_ACQUIRED_BASE_UP = 1003 /* for transage finger up */
...
typedef struct fingerprint_device {
    ...
    int (*authenticate)(struct fingerprint_device *dev, uint64_t operation_id, uint32_t gid);
     ...
     /** Close this device */
    int (*close)(struct fingerprint_device* device);
...
int fingerprint_open(const char *id, fingerprint_device_t** device);
